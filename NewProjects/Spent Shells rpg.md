...
| Light Ranged Weapon | 4 bullets | 1D6 damage, 4 durability, range near |
| Heavy Ranged Weapon | 6 bullets | 2D6 damage, 6 durability, range far |
| Shield | 2 bullets | 1 armour, 4 durability |
| Light Armour | 4 bullets | 1 armour, 8 durability |
| Heavy Armour | 7 bullets | 2 armour, 11 durability |
| “Good” Meal | 1 bullet | Or at least what they call a nice meal |
| Grenade | 5 bullets | 2D6+2 damage, single-use, range near. Targets roll durability checks for all equipment  |
...
| Tools | 6 bullets | Tools for a skilled trade |
| Torch | 1 bullet | Stuff on a stick that you can burn for light |
| Blanket | 2 bullets | Keeps you warm |
| Backpack | 2 bullets | Carry your things with you |
| shovel | 2 bullets | Finally you can dig holes and bury stuff |
| Crowbar | 3 bullets | Open things that don’t want to be opened |
| Fancy Clothes | 4 bullets | Or as fancy as anything gets around here |
| Tent | 5 bullets | Big enough for a few people, keep rain and wind out |
| Bedroll | 3 bullets | Sleep on a comfy pile of cloth and feathers |
| Harvested Plants | 1 bullet | Sell a bag of various plants you harvested |
| Harvested Animals | 2 bullets | Sell animal parts from what you caught/hunted |
| Harvested Minerals | 3 bullets | Sell a bag of various useful stones/ore |
...
Enemy modifiers: a better weapon gives them \+1 to their TN when attacking, or better armour gives them \+1 when defending.
...
Gather Info:  
Have each player that is approaching the camp roll a Deft check vs TN13 to avoid being seen as they take a look around. Whether or not they are spotted they see the following in the camp:  
...
Sneaky Rescue:  
Have each player make a Deft or Clever roll based on the way they are hiding. The TN of the enemies are what they need to beat. They can try to open the cage and free the prisoners by doing a Might check vs TN13. But the prisoners are in bad shape and will need help to escape.   
Attack the cultists:  
There are 4 human cultists and 3 devils. As the players fight to free the prisoners, the leader of the cultists will eventually sacrifice himself into the fire and cause the big creature to spawn out of the flames.  
...
Found items get random properties and durability.