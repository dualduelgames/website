...
| **5**   | **Enhance Weapon**    | A weapon becomes enchanted to deal Enhanced damage (d12) the next time it hits a target. But after that it immediately turns to dust and is destroyed. |
| **6**   | **asd**     | An. |
...
| **4**   | **Chat**              | You and another consciousness close to you can communicate with each other through your minds. You don’t have to share a language but you both need to know a language. Either creature can end the communication whenever they want. Those around are unaware of your communication. |
| **5**   | **Knock**             | A locked door/container you touch unlocks but also emits a loud knocking sound. |
| **6**   | **Push and Pull**     | You make a single interaction with an object within short range of you that you can see. You can only apply up to 25lbs of pressure this way. This effect lasts for only a minute. The effect ends early if the object leaves your line of sight for more than 1 second. |
...
| **4**   | **Frost Proof**       | You or a creature you touch becomes unable to feel the extreme cold of the environment for 2 hours. It still affects them in other ways, they just don’t feel it. |
| **5**   | **E**    | A. |
| **6**   | **a**     | A. |